...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='faces/uploads/', verbose_name='Image')),
                ('image_hash', models.CharField(editable=False, max_length=40, unique=True, verbose_name='SHA1 Image Hash')),
